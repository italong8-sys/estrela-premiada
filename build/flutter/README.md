...
* `projeto_estrela` - project identifier (lowercase, no spaces, i.e. "snake_case") used for bundle IDs and package names.
* `` - project description.
* `projeto_estrela` - executable or bundle name on disk.
* `projeto_estrela` - display name shown in window titles and about app dialogs.
